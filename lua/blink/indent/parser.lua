...
function M._get_indent_levels(bufnr, start_line, end_line, shiftwidth, cursor_line)
  ...
  local scope_search_start_line, scope_indent_level = M.get_scope_start(bufnr, cursor_line, shiftwidth)
...
--- Gets the scope range for the current line
--- @param bufnr? integer
--- @param winnr? integer
...
function M.get_scope(bufnr, winnr)
  ...
  return scope_indent_level, { start_line = scope_start_line, end_line = scope_end_line }
end
